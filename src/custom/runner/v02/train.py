...
def train_loop(
    ...
    # eval config
    config = set_config(pre_eval_config, train_data, valid_data, node_feature=node_feature)
...
def train_fold(pre_eval_config: dict, df: pd.DataFrame, node_feature, out_dir: Path) -> None:
